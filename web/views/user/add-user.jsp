...
<head>
    ...
    <title>Add New User &mdash; HRM System</title>
...
<div class="main-content">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
            <h5 class="fw-bold text-dark mb-0">Add New User</h5>
            <small class="text-muted">Create a new system account</small>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 p-4">
                ...
                <form action="${pageContext.request.contextPath}/users?action=add"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="password" class="form-label required">Initial Password</label>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="gender" name="gender" class="form-select">
                                ...
                                <c:forEach var="g" items="${genders}">
                                    <option value="${g}" ${param.gender == g ? 'selected' : ''}>
                                        ${g}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="col-md-6" id="departmentGroup" style="display: none;">
                            ...
                            <select id="departmentId" name="departmentId" class="form-select">
                                ...
                                <c:forEach var="d" items="${employeeDepartments}">
                                    <option value="${d.departmentId}"
                                            ${param.departmentId == d.departmentId ? 'selected' : ''}>
                                        ${d.departmentName}
                                    </option>
                                </c:forEach>
                            </select>
                            ...
                            <div class="form-text">
                                Employee's manager is assigned from this department.
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (dobInput) {
            ...
            dobInput.addEventListener('invalid', function () {
                dobInput.setCustomValidity('User must be at least 18 years old.');
            });
        ...
        // =========================
        // Show Department if role = EMPLOYEE
        // =========================
        function toggleDepartment() {
            if (!roleSelect || !deptGroup || !deptSelect) {
                return;
            }
            ...
            const roleName = selectedOption
                ? (selectedOption.getAttribute('data-role') || '').trim().toUpperCase()
                : '';
