    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
            <div class="card border-0 shadow-sm rounded-3 p-4">
                ...
                <form action="${pageContext.request.contextPath}/users?action=add" method="post" novalidate>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="username" name="username" class="form-control"
                                   ...
                                   value="${not empty param.username ? param.username : ''}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="password" class="form-label required">Initial Password</label>
                            <div class="input-group">
                                <input type="password" id="password" name="password" class="form-control"
                                       placeholder="Set initial password" required minlength="6">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="fullName" name="fullName" class="form-control"
                                   ...
                                   value="${not empty param.fullName ? param.fullName : ''}" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="gender" name="gender" class="form-select">
                                ...
                                <c:forEach var="g" items="${genders}">
                                    <option value="${g}" ${param.gender == g ? 'selected' : ''}>${g}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-md-6">
