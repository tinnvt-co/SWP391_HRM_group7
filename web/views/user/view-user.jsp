...
<head>
    ...
    <title>User Detail &mdash; HRM System</title>
    ...
    <style>
        ...
        .badge-role { background-color: #e3f0fb; color: #1a3c5e; padding: 5px 14px; border-radius: 20px; font-size: 0.8rem; font-weight: 600; }
    </style>
</head>
<body>
...
<div class="main-content">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
            ...
            <small class="text-muted">Viewing information for ${user.fullName}</small>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm rounded-3 p-4 mt-3">
                ...
                <div class="info-row row">
                    <div class="col-4 text-muted small">Updated At</div>
                    <div class="col-8">${not empty user.updatedAt ? user.updatedAt : '—'}</div>
                </div>
            </div>
        </div>
    </div>
