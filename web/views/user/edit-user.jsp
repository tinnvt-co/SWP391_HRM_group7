                            ...
                            <select id="departmentId" name="departmentId" class="form-select">
                                ...
                                <c:forEach var="d" items="${employeeDepartments}">
                                    <option value="${d.departmentId}"
                                            ${not empty employee && employee.departmentId == d.departmentId ? 'selected' : ''}>
                                        ${d.departmentName}
                                    </option>
                                </c:forEach>
                            </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (dobInput) {
            ...
            dobInput.max = maxBirthDate.toISOString().split('T')[0];

            dobInput.addEventListener('invalid', function () {
                if (dobInput.validity.rangeOverflow) {
            ...
            dobInput.addEventListener('change', function () {
                ...
                if (dobInput.value && dobInput.value > dobInput.max) {
                    dobInput.setCustomValidity('User must be at least 18 years old.');
        ...
        function toggleDepartment() {
            ...
            const roleName = selected
                ? (selected.getAttribute('data-role') || '').trim().toUpperCase()
                : '';
